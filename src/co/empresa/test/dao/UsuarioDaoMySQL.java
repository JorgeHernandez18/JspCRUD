...
public class UsuarioDaoMySQL implements UsuarioDao {
	...
	private static final String SELECT_USUARIO_SQL_BY_ID = "SELECT * FROM usuario WHERE id = ?;";
	...
	//Metodo para borrar en nuestra base de datos
	...
	public Usuario select(int id){
		...
		try {
			PreparedStatement preparedStatement = (PreparedStatement) conexion.setPreparedStatement(SELECT_USUARIO_SQL_BY_ID);
			preparedStatement.setInt(1, id);
			ResultSet rs = conexion.query();
